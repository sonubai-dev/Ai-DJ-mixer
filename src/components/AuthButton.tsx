    ...
    return (
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="hidden sm:inline text-sm font-rajdhani text-gray-300">{displayName}</span>
        </div>
        <button
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="bg-gray-900 border border-orange-500/30 rounded-2xl max-w-md w-full p-6 shadow-2xl shadow-orange-900/20 relative"
            >
              <button
              ...
              <h3 className="text-2xl font-orbitron text-white mb-6 text-center">
                {isLogin ? 'Welcome Back' : 'Join the Studio'}
              </h3>

              {quirkyFact && (
                <div className="mb-6 bg-orange-500/10 border border-orange-500/20 rounded-lg p-3 text-center">
                  ...
                  <p className="text-[10px] text-orange-500/60 mt-1">Weirdness Level: {quirkyFact.weirdness_level}/10</p>
                </div>
              )}
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-lg py-2 pl-10 pr-4 text-white focus:outline-none focus:border-orange-500 transition-colors"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-600 hover:bg-orange-500 text-white py-2 rounded-lg font-orbitron tracking-wider transition-colors disabled:opacity-50"
                >
